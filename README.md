...
```javascript
import sfill from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-sfill@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-sfill/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-sfill/actions/workflows/test.yml?query=branch:v0.2.1
